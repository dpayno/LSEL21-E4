...
void door_fsm_init(struct_fsm_door_checking* this, uint8_t active, uint8_t door_opened, uint8_t flag_door_open)
{
	printf("init_starting\n");
	fsm_init((fsm_t*)this, door_trans);
	*(this->u8_active) = active;
	*(this->u8_door_opened) = door_opened;
	*(this->u8_flag_door_open) = flag_door_open;
